            ...
            <template #header>
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <h3 class="text-lg font-semibold text-gray-900">{{ mcpServerDisplayName }}</h3>
                    </div>
                    <UButton
                        color="gray"
                        variant="ghost"
                ...
                <p class="text-sm text-gray-500 mt-2">
                    Connect Claude, Cursor, or any MCP client to query your data via the {{ mcpServerDisplayName }}.
                </p>
            </template>
...
const { mcpServerDisplayName, mcpClientKeyName } = useBranding()
